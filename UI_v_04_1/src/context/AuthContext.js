...
const inputGrocery = (dispatch) => {
    ...
    return async ({name, Quantity, Expiration}) => {
        ...
        const str = baseURL +usr+ token+ itemName + name+  date + Expiration ;
        console.log(str);
...
export const {Provider, Context} = createDataContext(
    authReducer,
    {signin, signout, signup, clearErrorMessage, tryLocalSignin, inputGrocery,inputWeight,inputCalories,searchApi},
